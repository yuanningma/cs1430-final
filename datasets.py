...
class Datasets():
    ...
    def calc_mean_and_std(self):
        ...
        # ==========================================================
        mean, variance = tf.nn.moments(tf.convert_to_tensor(data_sample), axes=[0,1,2])


        self.mean = mean
        self.std = tf.math.sqrt(variance)
        # self.mean = np.mean(data_sample, axis=2)
        # self.std = np.std(data_sample, axis=2)
        #
        # print(self.mean)
        # print(self.std)
        # ==========================================================
